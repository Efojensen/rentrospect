...
const SignIn = () => {
    ...
    return (
        <main className='flex flex-col sm:flex-row-reverse px-5'>
            <Image
            ...
            <div className='flex flex-col gap-6 mb-30'>
                ...
                <p className='text-smallGreyText dmSans-font text-sm leading-[1.225rem] tracking-[-0.0131rem] mx-auto'>Already have an account? <Link href='/signUp' className='font-medium underline text-loginTextClr'>Login</Link></p>
